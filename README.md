...
| `assignAircraft`     | string `username`, string `tailNumber`                                     | bool `success`      | Admin                       | Assign the maintainer to the aircraft so they have access to the data                                                                       |
...
| `sellAircraft`       | string `tailNumber`, string `username`                                     | bool `success`      | Admin                       | Transfers ownership of aircraft to new account, and removes maintainers access                                                              |
